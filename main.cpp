...
int sc_main(int argc, char* argv[]){
    sc_signal<bool> clk;
    clk.write(true);
    sc_signal<sc_bv<34>>from1to2; 
    from1to2.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val1to2;
    val1to2.write(false);
    sc_signal<bool>ack1to2;
    ack1to2.write(false);
    sc_signal<sc_bv<34>>from1to5; 
    from1to5.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val1to5;
    val1to5.write(false);
    sc_signal<bool>ack1to5;
    ack1to5.write(false);
    sc_signal<sc_bv<34>>from1to8; 
    from1to8.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val1to8;
    val1to8.write(false);
    sc_signal<bool>ack1to8;
    ack1to8.write(false);
    sc_signal<sc_bv<34>>from2to1; 
    from2to1.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val2to1;
    val2to1.write(false);
    sc_signal<bool>ack2to1;
    ack2to1.write(false);
    sc_signal<sc_bv<34>>from2to3; 
    from2to3.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val2to3;
    val2to3.write(false);
    sc_signal<bool>ack2to3;
    ack2to3.write(false);
    sc_signal<sc_bv<34>>from2to6; 
    from2to6.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val2to6;
    val2to6.write(false);
    sc_signal<bool>ack2to6;
    ack2to6.write(false);
    sc_signal<sc_bv<34>>from3to2; 
    from3to2.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val3to2;
    val3to2.write(false);
    sc_signal<bool>ack3to2;
    ack3to2.write(false);
    sc_signal<sc_bv<34>>from3to4; 
    from3to4.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val3to4;
    val3to4.write(false);
    sc_signal<bool>ack3to4;
    ack3to4.write(false);
    sc_signal<sc_bv<34>>from3to7; 
    from3to7.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val3to7;
    val3to7.write(false);
    sc_signal<bool>ack3to7;
    ack3to7.write(false);
    sc_signal<sc_bv<34>>from4to3; 
    from4to3.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val4to3;
    val4to3.write(false);
    sc_signal<bool>ack4to3;
    ack4to3.write(false);
    sc_signal<sc_bv<34>>from4to5; 
    from4to5.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val4to5;
    val4to5.write(false);
    sc_signal<bool>ack4to5;
    ack4to5.write(false);
    sc_signal<sc_bv<34>>from4to8; 
    from4to8.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val4to8;
    val4to8.write(false);
    sc_signal<bool>ack4to8;
    ack4to8.write(false);
    sc_signal<sc_bv<34>>from5to1; 
    from5to1.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val5to1;
    val5to1.write(false);
    sc_signal<bool>ack5to1;
    ack5to1.write(false);
    sc_signal<sc_bv<34>>from5to4; 
    from5to4.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val5to4;
    val5to4.write(false);
    sc_signal<bool>ack5to4;
    ack5to4.write(false);
    sc_signal<sc_bv<34>>from5to6; 
    from5to6.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val5to6;
    val5to6.write(false);
    sc_signal<bool>ack5to6;
    ack5to6.write(false);
    sc_signal<sc_bv<34>>from6to2; 
    from6to2.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val6to2;
    val6to2.write(false);
    sc_signal<bool>ack6to2;
    ack6to2.write(false);
    sc_signal<sc_bv<34>>from6to5; 
    from6to5.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val6to5;
    val6to5.write(false);
    sc_signal<bool>ack6to5;
    ack6to5.write(false);
    sc_signal<sc_bv<34>>from6to7; 
    from6to7.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val6to7;
    val6to7.write(false);
    sc_signal<bool>ack6to7;
    ack6to7.write(false);
    sc_signal<sc_bv<34>>from7to3; 
    from7to3.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val7to3;
    val7to3.write(false);
    sc_signal<bool>ack7to3;
    ack7to3.write(false);
    sc_signal<sc_bv<34>>from7to6; 
    from7to6.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val7to6;
    val7to6.write(false);
    sc_signal<bool>ack7to6;
    ack7to6.write(false);
    sc_signal<sc_bv<34>>from7to8; 
    from7to8.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val7to8;
    val7to8.write(false);
    sc_signal<bool>ack7to8;
    ack7to8.write(false);
    sc_signal<sc_bv<34>>from8to1; 
    from8to1.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val8to1;
    val8to1.write(false);
    sc_signal<bool>ack8to1;
    ack8to1.write(false);
    sc_signal<sc_bv<34>>from8to4; 
    from8to4.write(sc_bv<34>("0000000000000000000000000000000000"));
    sc_signal<bool>val8to4;
    val8to4.write(false);
    sc_signal<bool>ack8to4;
    ack8to4.write(false);
    sc_signal<sc_bv<34>>from8to7; 
    from8to7.write(sc_bv<34>("0000000000000000000000000000000000"));
